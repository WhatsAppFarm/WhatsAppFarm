...
namespace WhatsAppFarm.Client
{
    public class ApplicationAuthenticationStateProvider : AuthenticationStateProvider
    {
        private const string AuthenticationStateKey = "WhatsAppFarm.Server.AuthenticationState";
        ...
        public override async Task<AuthenticationState> GetAuthenticationStateAsync()
        {
            ...
            try
            {
                ...
                {
                    identity = new ClaimsIdentity(state.Claims.Select(c => new Claim(c.Type, c.Value)), "WhatsAppFarm.Server");
                }
            }
