        ...
        public async Task<IActionResult> Login(string userName, string password, string redirectUrl)
        {
            ...
            if (!string.IsNullOrEmpty(userName) && !string.IsNullOrEmpty(password))
            {
                ...
                if (result.RequiresTwoFactor && !isTenantsAdmin)
                {
                    ...
                    var text = $@"Hi, <br /> <br />
We received your request for a single-use code to use with your WhatsAppFarm account. <br /> <br />
        ...
        public async Task<IActionResult> Register(string userName, string password)
        {
            ...
            if (result.Succeeded)
            {
                try
                {
                    ...
                    var text = $@"Hi, <br /> <br />
We received your registration request for WhatsAppFarm. <br /> <br />
